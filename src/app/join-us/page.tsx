...
每個專案的總報酬中，首先由系學會抽成10%，接著專案負責人再抽成10%。剩下的85%報酬將根據各成員(包括專案負責人)的貢獻比例進行分配。在專案開始前，會列出所有需要完成的工作事項並估算完成工作的預計時間。在專案開發期間，會記錄每位成員完成的工作事項。最終每位成員的貢獻比例為，其完成的工作的預計時間總和除以專案所有工作的預計時間總和，並依此比例分配報酬。
